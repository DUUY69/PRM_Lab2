...
class _DetailScreenState extends State<DetailScreen> {
  ...
  List<Widget> _buildAuthorsSection(Publication publication) {
  ...
  List<Widget> _buildRelatedSection(BuildContext context) {
    return [
      const SizedBox(height: 16),
      const Divider(),
      const SizedBox(height: 16),
  ...
  List<Widget> _buildRelatedContent(BuildContext context) {
    if (_loadingRelated) {
      return [
        const Center(
          child: Padding(
